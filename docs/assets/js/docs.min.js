 ...
 */
!function(a){"use strict";a(function(){a(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body"}),a('[data-toggle="popover"]').popover(),a(".tooltip-test").tooltip(),a(".popover-test").popover(),a(".bd-example [href=#]").click(function(a){a.preventDefault()}),ZeroClipboard.config({moviePath:"/assets/flash/ZeroClipboard.swf",hoverClass:"btn-clipboard-hover"}),a(".highlight").each(function(){var b='<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>';a(this).before(b)});var b=new ZeroClipboard(a(".btn-clipboard")),c=a("#global-zeroclipboard-html-bridge");b.on("load",function(){c.data("placement","top").attr("title","Copy to clipboard").tooltip(),b.on("dataRequested",function(b){var c=a(this).parent().nextAll(".highlight").first();b.setText(c.text())}),b.on("complete",function(){c.attr("title","Copied!").tooltip("fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("fixTitle")})}),b.on("noflash wrongflash",function(){a(".zero-clipboard").remove(),ZeroClipboard.destroy()})})}(jQuery),function(){"use strict";anchors.options.placement="left",anchors.add(".bd-content > h1, .bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5")}(),function(a){"use strict";function b(a){var b=[];return a.grouped_by_page_header&&b.push('<div class="suggestion-page">'+a.page+"</div>"),b.push('<div class="suggestion">'),b.push('  <div class="suggestion-context">'),a.grouped_by_h1_header&&b.push(a.h1),b.push("  </div>"),b.push('  <div class="suggestion-content">'),b.push('    <div class="suggestion-title">'),a.h1_highlight&&b.push('      <span class="suggestion-title-prefix">'+a.h1_highlight+"</span>"),a.title&&b.push('      <span class="suggestion-title-hierarchy">'+a.title+"</span>"),b.push("    </div>"),a.text&&b.push('    <div class="suggestion-text">'+a.text+"</div>"),b.push("  </div>"),b.push("</div>"),b.join("")}function c(){return['<a href="http://www.algolia.com/?utm_source=bootstrap&amp;utm_medium=link&amp;utm_campaign=bootstrap_documentation_search" target="_blank" class="search-footer text-hide">',"Powered by Algolia","</a>"].join("")}function d(b,c){var d={query:b,"x-algolia-api-key":"b107a5216b65db8915163e97bdc28234","x-algolia-application-id":"NNYOET9BZD",hitsPerPage:5},e=["dsn.algolia.net","1.algolianet.com","2.algolianet.com","3.algolianet.com"];!function f(b){if(b>=e.length)return void c([]);var g="https://NNYOET9BZD-"+e[b]+"/1/indexes/bootstrap";a.ajax({url:g,data:d,timeout:2e3*(b+1)}).then(function(a){c(i(a.hits))},function(){f(b+1)})}(0)}function e(b,c,d){return d=a.extend({},{highlight:!1},d),d.highlight?b._highlightResult[c].value:b[c]}function f(b,c){var d=b.tag_name;if("h1"===d)return"Go to "+e(b,"text",c);var f=[];return a.each(["h2","h3","h4","h5","h6"],function(a,d){b[d]&&f.push(e(b,d,c))}),f.join(" › ")}function g(a){if("p"!==a.tag_name)return null;var b=a._snippetResult.text.value;return b[0]!==b[0].toUpperCase()&&(b="…"+b),"."!==b.slice(-1)&&(b+="…"),b}function h(b,c){var d={};return a.each(b,function(a,b){var e=b[c];return d[e]?void d[e].push(b):(b["grouped_by_"+c+"_header"]=!0,void(d[e]=[b]))}),d}function i(b){b=a.map(b,function(a){return{page:a.title,h1:a.h1,h1_highlight:a._highlightResult.h1.value,title:f(a,{highlight:!0}),raw_title:f(a,{highlight:!1}),text:g(a),url:a.url,_original:a}});var c=h(b,"page"),d=[];return a.each(c,function(b,c){var e=h(c,"h1");a.each(e,function(a,b){d=d.concat(b)})}),d}function j(a,b){k.typeahead("val",""),window.location.href=b.url}var k=a(".bs-docs-nav .bs-search .form-control"),l={hint:!1,autoselect:!0},m={displayKey:function(){return k.val()},source:d,templates:{suggestion:function(a){return b(a)},footer:function(){return c()}}};a(function(){a(".bs-docs-nav.bs-no-js").removeClass("bs-no-js"),k.typeahead(l,m).bind("typeahead:selected",j);var b=a("#bs-toggle-search"),c=a(".bs-toggle-search-open");c.on("click",function(a){b.click(),k.focus(),a.preventDefault()});var d=k.parent(),e=k.nextAll(".tt-dropdown-menu");d.css("display","block"),e.css("top",k.outerHeight()+"px")})}(jQuery);